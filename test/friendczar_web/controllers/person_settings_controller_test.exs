defmodule FriendczarWeb.PersonSettingsControllerTest do
  ...
  describe "GET /persons/settings" do
  ...
  describe "PUT /persons/settings (change password form)" do
  ...
  describe "PUT /persons/settings (change email form)" do
    @tag :capture_log
    test "updates the person email", %{conn: conn, person: person} do
      ...
      assert Authentication.get_person_by_email(person.email)
    end
  ...
  describe "GET /persons/settings/confirm_email/:token" do
    ...
    test "updates the person email once", %{conn: conn, person: person, token: token, email: email} do
      ...
      refute Authentication.get_person_by_email(person.email)
      assert Authentication.get_person_by_email(email)
