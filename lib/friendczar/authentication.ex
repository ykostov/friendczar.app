defmodule Friendczar.Authentication do
  @moduledoc """
  ...
  alias Friendczar.Authentication.{Person, PersonToken, PersonNotifier}
  ...
  defp person_email_multi(person, email, context) do
    changeset = person |> Person.email_changeset(%{email: email}) |> Person.confirm_changeset()
  ...
  ## Examples
      ...
      iex> deliver_person_confirmation_instructions(person, &Routes.person_confirmation_url(conn, :confirm, &1))
      {:ok, %{to: ..., body: ...}}

      iex> deliver_person_confirmation_instructions(confirmed_person, &Routes.person_confirmation_url(conn, :confirm, &1))
