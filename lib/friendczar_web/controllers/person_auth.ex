defmodule FriendczarWeb.PersonAuth do
  import Plug.Conn
  ...
  def log_out_person(conn) do
    ...
    person_token && Authentication.delete_session_token(person_token)

    if live_socket_id = get_session(conn, :live_socket_id) do
      FriendczarWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  def fetch_current_person(conn, _opts) do
    ...
    person = person_token && Authentication.get_person_by_session_token(person_token)
